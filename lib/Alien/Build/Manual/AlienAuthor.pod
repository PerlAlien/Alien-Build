...
(Aside2, C<pkg-config> is a stadard-ish way to provide the compiler and 
linker flags needed for compiling and linking aginst the library.  If 
...
Here is the L<alienfile> that you might have:
 ...
 share {
   ...
   download [ 'wget http://www.libfoo.com/src/libfoo-1.00.tar.gz' ];
